...
<body>
    ...
    <main class="scc-main">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h4 class="fw-bold mb-1" style="color:var(--text)">Edit <span style="color:var(--primary)">Course</span>
                </h4>
                <p style="font-size:0.85rem;color:var(--text-secondary);margin:0">Update existing course information in
                    the institutional catalog</p>
            </div>
            <div>
        ...
        <div class="scc-card animate-in" style="max-width: 600px; margin: 0 auto;">
            <div class="card-header border-0 bg-transparent p-4 pb-0 text-center">
                <h6 class="fw-bold mb-0" style="color:var(--text)">Course <span style="color:var(--primary)">Catalog
                        Update</span></h6>
                <p class="small text-muted">Modify existing course parameters below</p>
            </div>
            <div class="card-body p-4 p-md-5">
                <?php if ($error): ?>
                    <div class="alert alert-danger border-0 shadow-sm mb-4 d-flex align-items-center animate-in"
                ...
                <form method="POST">
                    <div class="mb-4">
                        <label class="form-label fw-bold small text-secondary">Course Code <span
                                class="text-danger">*</span></label>
                        <input type="text" name="course_code" class="form-control"
                            value="<?= htmlspecialchars($course['course_code']) ?>" required>
                    </div>
                    <div class="mb-4">
                        <label class="form-label fw-bold small text-secondary">Course Title <span
                                class="text-danger">*</span></label>
                        <input type="text" name="course_title" class="form-control"
                            value="<?= htmlspecialchars($course['course_title']) ?>" required>
                    </div>
                    <div class="mb-5">
                        <label class="form-label fw-bold small text-secondary">Assigned College <span
                                class="text-danger">*</span></label>

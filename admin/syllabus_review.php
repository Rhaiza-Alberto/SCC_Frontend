...
<head>
    ...
    <title>Syllabus Review - Dean's Panel</title>
        ...
        <div class="main-content flex-grow-1 p-5" style="margin-left:260px;">
            ...
            <div class="card premium-card p-4 mb-5 shadow-sm border-0">
                <ul class="nav nav-tabs nav-fill mb-4 border-bottom" role="tablist">
                    <li class="nav-item">
                        <button class="nav-link <?= (!isset($_GET['status']) || $_GET['status'] === 'Pending') ? 'active' : '' ?> font-serif fw-bold text-orange" data-bs-toggle="tab"
                            data-bs-target="#tabPending" type="button">
                            Pending Approval <?php if ($pending_count > 0): ?><span
                                    class="badge bg-warning text-dark ms-1"><?= $pending_count ?></span><?php endif; ?>
                        </button>
                    </li>
                    <li class="nav-item">
                        <button class="nav-link <?= (isset($_GET['status']) && $_GET['status'] === 'Approved') ? 'active' : '' ?> font-serif fw-bold text-orange" data-bs-toggle="tab"
                            data-bs-target="#tabApproved" type="button">
                            Approved <?php if (count($approved_rows) > 0): ?><span
                                    class="badge bg-success ms-1"><?= count($approved_rows) ?></span><?php endif; ?>
                        </button>
                    </li>
                    <li class="nav-item">
                        <button class="nav-link <?= (isset($_GET['status']) && $_GET['status'] === 'Rejected') ? 'active' : '' ?> font-serif fw-bold text-orange" data-bs-toggle="tab"
                            data-bs-target="#tabDeclined" type="button">
                            Declined <?php if (count($rejected_rows) > 0): ?><span
                                    class="badge bg-danger ms-1"><?= count($rejected_rows) ?></span><?php endif; ?>
                        </button>
                    </li>
                </ul>
                            ...
                            <table class="table table-hover align-middle">
                                ...
                                <tbody>
                                    <?php if (empty($pending_rows)): ?>
                                        <tr>
                                            <td colspan="8" class="text-center text-muted py-4">No submissions awaiting
                                                approval</td>
                                        </tr>
                                    <?php else:
                                        foreach ($pending_rows as $i => $sub): ?>
                                            <tr>
                                                ...
                                                <td><span
                                                        ...
                                                        style="font-size:.75rem;">Pending</span></td>
                            ...
                            <table class="table table-hover align-middle">
                                ...
                                <tbody>
                                    <?php if (empty($approved_rows)): ?>
                                        <tr>
                                            <td colspan="6" class="text-center text-muted py-4">No approved submissions</td>
                                        </tr>
                                    <?php else:
                                        foreach ($approved_rows as $i => $sub): ?>
                                            <tr>
                                                ...
                                                <td><span
                                                        ...
                                                        style="font-size:.75rem;">Approved</span></td>
                                                <td class="text-center">
                                                    <a href="../faculty/view_syllabus.php?file=<?= urlencode(basename($sub['file_path'])) ?>"
                                                        target="_blank" class="btn btn-sm btn-link text-orange p-0">
                                                        <i class="bi bi-file-earmark-pdf fs-5"></i>
                            ...
                            <table class="table table-hover align-middle">
                                ...
                                <tbody>
                                    <?php if (empty($rejected_rows)): ?>
                                        <tr>
                                            <td colspan="7" class="text-center text-muted py-4">No declined submissions</td>
                                        </tr>
                                    <?php else:
                                        foreach ($rejected_rows as $i => $sub): ?>
                                            <tr>
                                                ...
                                                <td><span
                                                        ...
                                                        style="font-size:.75rem;">Rejected</span></td>

        ...
        <div class="row g-4 mb-5">
            <div class="col-lg-8">
                <div class="card premium-card p-4 shadow-sm h-100 border-0 rounded-4">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <span class="badge bg-warning bg-opacity-10 text-warning border border-warning rounded-pill px-3 py-1 small">
            ...
            <div class="col-lg-4">
                <div class="card premium-card p-4 shadow-sm h-100 border-0 rounded-4">
                    ...
                    <?php else: foreach ($notifications as $n): ?>
                        <div class="d-flex align-items-start mb-3 pb-2 border-bottom <?= !$n['is_read'] ? 'fw-semibold' : '' ?>">
            ...
            <div class="col-md-6">
                <div class="card premium-card p-4 h-100 shadow-sm border-0 border-top border-warning border-4 rounded-4 bg-white">
                    ...
                    <div class="d-flex align-items-center mt-auto">
                        <span class="badge rounded-pill me-2 <?= $pending_review_count > 0 ? 'bg-warning text-dark' : 'bg-secondary opacity-75' ?> px-2 py-1" style="font-size:.75rem;">
                            <?= $pending_review_count ?> Pending
                        </span>
                        <span class="text-muted small"><?= $pending_review_count > 0 ? 'awaiting your review' : 'no pending review' ?></span>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="card premium-card p-4 h-100 shadow-sm border-0 border-top border-orange border-4 rounded-4 bg-white">
                    ...
                    <div class="d-flex align-items-center mt-auto">
                        <span class="badge rounded-pill me-2 <?= $reg_count > 0 ? 'bg-warning text-dark' : 'bg-secondary opacity-75' ?> px-2 py-1" style="font-size:.75rem;">
                            <?= $reg_count ?> New
                        </span>
                        <span class="text-muted small"><?= $reg_count > 0 ? 'pending approval' : 'no pending approval' ?></span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="card premium-card p-4 shadow-sm bg-light border-0 rounded-4">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <a href="shared_syllabus.php" class="btn btn-sm btn-orange rounded-pill px-4 shadow-sm">Explore Repository</a>
                    </div>
                    <div class="row g-4 align-items-center">
                        ...
                        <div class="col-md-6 ps-md-4">
                            <p class="text-muted small mb-0">Your department repository is the single source of truth for all validated academic content. It ensures consistency across all subject offerings and facilitates peer review and quality management.</p>
                        </div>
                    </div>
                </div>
            </div>

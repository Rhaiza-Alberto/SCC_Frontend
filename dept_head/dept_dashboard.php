            ...
            <div class="d-flex justify-content-between align-items-center mb-5">
                ...
                <div class="alert alert-danger border-0 shadow-sm mb-4 d-flex align-items-center p-3 rounded-4" style="background-color: rgba(220, 53, 69, 0.1);">
                    ...
                    <div class="flex-grow-1">
                        <h6 class="fw-bold mb-0 text-dark">Action Required – New Syllabi for Review</h6>
                        <p class="mb-0 text-muted small">There are <?= $pending_review_count ?> syllabus submission(s) from your college awaiting your approval.</p>
                    </div>
                    <a href="syllabus_review.php" class="btn btn-sm btn-danger rounded-pill px-3 ms-3">Review Now</a>
                </div>
                <?php endif; ?>
                    ...
                    <div class="col-lg-8">
                        <div class="card premium-card p-4 shadow-sm h-100 border-0 rounded-4">
                            ...
                            <div class="row g-4 mb-4">
                                <div class="col-4">
                                    <div
                                        class="p-3 rounded-3 bg-light text-center border-bottom border-warning border-4">
                                ...
                                <div class="col-4">
                                    <div
                                        class="p-3 rounded-3 bg-light text-center border-bottom border-primary border-4">
                                ...
                                <div class="col-4">
                                    <div
                                        class="p-3 rounded-3 bg-light text-center border-bottom border-success border-4">
                        ...
                        <div
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <a href="syllabus_review.php"
                                    class="btn btn-sm btn-outline-warning rounded-pill px-3">View
                                    All</a>
                            </div>
                            <h5 class="card-title font-serif fw-bold mb-2">Syllabus Review</h5>
                            <p class="text-muted small mb-4">Manage faculty syllabus submissions awaiting your approval.
                            </p>
                ...
                <!-- College Repository Overview -->
                <div class="row g-4 mb-5">
                    <div class="col-12">
                        <div class="card premium-card p-4 shadow-sm bg-light border-0 rounded-4">
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                <h5 class="card-title font-serif fw-bold mb-0 text-orange">Department Repository
                                    Overview
                                </h5>
                            ...
                            <div class="row g-4 align-items-center">
                                ...
                                <div class="col-md-6 ps-md-4">
                                    <p class="text-muted small mb-0">Your department repository is the single source of
                                        truth for all validated academic content. It ensures consistency across all
                                        subject

    ...
    <div class="d-flex">
        ...
        <div class="main-content flex-grow-1 p-5" style="margin-left: 260px;">
            ...
            <div class="stat-card-content p-2">
                ...
                <h1 class="display-5 fw-bold text-dark mb-0"><?php echo $pending_count; ?></h1>
                <p class="text-muted small mb-0 mt-1">
                    <?php echo $pending_count > 0 ? $pending_count . ' awaiting review' : 'All caught up'; ?>
                </p>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card stat-card stat-card-rejected shadow-sm border-0 bg-white"
            ...
            <div class="stat-card-content p-2">
                ...
                <h1 class="display-5 fw-bold text-dark mb-0"><?php echo $rejected_count; ?></h1>
        ...
        <div class="col-md-6">
            <div class="card premium-card p-4 h-100 shadow-sm border-orange border-opacity-25">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <a href="registration_requests.php" class="btn btn-sm btn-orange rounded-pill px-3">Manage</a>
                </div>
        ...
        <div class="col-md-12">
            <div class="card premium-card p-4 shadow-sm bg-gradient-light border-0">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="shared_syllabus.php" class="btn btn-sm btn-orange rounded-pill px-4 shadow-sm">Explore
                        Repository</a>
                </div>

...
<body class="bg-light">
    ...
    <div class="d-flex">
        ...
        <div class="main-content flex-grow-1 p-5" style="margin-left: 280px;">
            <h2 class="text-orange font-serif fw-bold mb-4">Faculty Submissions for Approval</h2>
                    ...
                    <table class="table table-hover align-middle">
                        ...
                        <tbody>
                            ...
                            if (empty($submissions)) {
                                // Show empty state
                                echo '<tr>';
                                echo '<td colspan="11" class="text-center text-muted py-4">No submissions to review</td>';
                                echo '</tr>';
                            } else {
                                $counter = 1;
                                foreach ($submissions as $submission) {
                                    ...
                                    echo '<span class="fw-bold small">' . htmlspecialchars($submission['instructor_name']) . '</span>';
                                    echo '<span class="text-muted small" style="font-size: 0.75rem;">' . htmlspecialchars($submission['instructor_email']) . '</span>';
                                    echo '</div>';
                                    echo '</td>';

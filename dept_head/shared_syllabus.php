...
$colleges_list = array_unique(array_filter(array_column($approved_syllabi, 'college_name')));
    ...
    <div class="d-flex">
        ...
        <div class="sidebar sidebar-premium text-white p-2 min-vh-100 d-flex flex-column"
            ...
            <nav class="nav flex-column gap-2 mb-auto">
                ...
                <a href="shared_syllabus.php" class="nav-link text-white p-3 rounded active-nav-link">Shared
                    Syllabus</a>
        ...
        <div class="main-content flex-grow-1 p-5" style="margin-left:260px;">
            ...
            <div class="d-flex justify-content-between align-items-center mb-5">
                <div>
                    ...
                    <p class="text-muted small mb-0">Browse and download VPAA-approved syllabi across all departments.
                    </p>
                </div>
            ...
            <div class="row g-4 mb-5">
                <div class="col-md-3">
                    <div class="card premium-card border-0 shadow-sm p-3 syllabus-card"
                        style="border-left-color:#ff8800;">
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        <div class="input-group">
                            ...
                            <input type="text" id="search-input" class="form-control border-start-0 ps-0 search-box"
                    ...
                    <div class="col-md-2">
                        <button class="btn btn-orange w-100 rounded shadow-sm" onclick="resetFilters()">Reset
                            Filters</button>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table table-hover align-middle table-premium mb-0" id="syllabi-table">
                        ...
                        <tbody>
                            <?php if (empty($approved_syllabi)): ?>
                                <tr>
                                    <td colspan="6" class="text-center py-5 text-muted small">No approved syllabi found in
                                        the repository.</td>
                                </tr>
                            <?php else:
                                foreach ($approved_syllabi as $s): ?>
                                    <tr class="syllabus-row" data-dept="<?= htmlspecialchars($s['college_name'] ?? '') ?>"
                                        data-type="<?= htmlspecialchars($s['subject_type']) ?>"
                                        data-year="<?= htmlspecialchars($s['school_year']) ?>">
                                        <td class="ps-4">
                                            <div class="d-flex flex-column">
                                                <span
                                                    class="fw-bold small text-dark row-course-code"><?= htmlspecialchars($s['course_code']) ?></span>
                                                <span class="text-muted small text-truncate row-course-title"
                                                    style="max-width:200px;"><?= htmlspecialchars($s['course_title']) ?></span>
                                            </div>
                                        </td>
                                        <td>
                                            <?php
                                        ...
                                        <td class="small text-muted"><?= htmlspecialchars($s['college_name'] ?? 'General') ?>
                                        </td>
                                        <td>
                                            <div class="small fw-bold"><?= htmlspecialchars($s['school_year']) ?></div>
                                            <div class="text-muted" style="font-size:.65rem;">
                                                <?= htmlspecialchars($s['semester']) ?></div>
                                        </td>

...
<nav class="scc-sidebar" id="sidebar">
        <div class="sidebar-brand">
                ...
                <h6 class="fw-bold mb-0" style="color:var(--primary);font-family:var(--font-serif)">Faculty Panel</h6>
                <small style="color:rgba(255,255,255,0.5);font-size:0.72rem"><?= htmlspecialchars($_username) ?></small>
        </div>
        <div class="sidebar-section">OVERVIEW</div>
        <a href="faculty_dashboard.php" class="nav-item <?= ($active_page ?? '') === 'dashboard' ? 'active' : '' ?>"><i

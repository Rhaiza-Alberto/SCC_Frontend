...
<body>
    ...
    <div class="d-flex">
        <main class="scc-main flex-grow-1 p-5">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0" style="width:340px;max-height:420px;overflow-y:auto;border-radius:var(--radius-md);background:var(--bg-card)">
                            ...
                            <li style="background:var(--bg-card);border-top:1px solid var(--border)">
                                <a href="notifications.php" class="d-block text-center text-decoration-none small fw-bold py-2" style="color:var(--primary)">View all notifications</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div id="syllabi-container" class="row g-3">
                ...
                <?php else: ?>
                    <?php foreach ($approved_syllabi as $row): 
                        // Dynamically compute Year Level based on the course code numbering signature system
                        preg_match('/\d/', $row['course_code'], $matches);
                        $first_digit = $matches[0] ?? '';
                        $year_level = '1st Year'; // Default fall-through state
                        if ($first_digit === '2') $year_level = '2nd Year';
                        elseif ($first_digit === '3') $year_level = '3rd Year';
                        elseif ($first_digit === '4') $year_level = '4th Year';
                    ?>
                                ...
                                <div class="card-body p-3">
                                    ...
                                    <div class="mt-3 pt-2 border-top">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mt-2">
                                            ...
                                            <div class="text-end">
                                                <div style="font-size: 0.6rem; color: var(--text-muted); text-transform: uppercase; font-weight: 700;">Year / Semester</div>
                                                <div class="small fw-bold text-orange" style="font-size: 0.71rem;"><?= $year_level ?> / <?= htmlspecialchars($row['semester']) ?></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>

...
<body>
    ...
    <section class="hero-section text-center py-5">
        <div class="container py-5 mt-5">
            <h1 class="display-4 fw-bold font-serif mb-3">Welcome to College of Computing Studies</h1>
            <h2 class="h4 text-muted mb-4 font-serif">Course Syllabus Approval Portal</h2>

...
<body>
    <div class="auth-wrapper">
        <div class="auth-form-side">
            <div class="auth-form-container animate-in" style="max-width:420px">
                ...
                <?php else: ?>
                    ...
                    <h1 style="font-size:1.5rem">Verification Required</h1>
                    <p class="subtitle">Please enter the 6-digit code sent to <strong class="text-orange"><?= htmlspecialchars($email) ?></strong></p>
                    ...
                    <form method="POST">
                        ...
                        <button type="submit" class="btn btn-primary-scc w-100 py-3 fw-bold mb-4 shadow-sm" style="font-size:1rem; border-radius: 12px;">
                            Verify and Activate <i class="bi bi-arrow-right ms-2"></i>
                        </button>
                    </form>
        ...
        <div class="auth-illustration-side" style="background: linear-gradient(135deg, #1a1a1a 0%, #333 100%);">
            <div class="text-center text-white px-5" style="position:relative;z-index:2;max-width:400px">
                ...
                <p style="color:rgba(255,255,255,0.6); font-size:0.95rem; line-height:1.6">Verifying your institutional credentials ensures safety, workflow confidentiality, and valid syllabus tracking across all department profiles.</p>
            </div>
    ...
    <script>
        // Restrict user entry cleanly to numerical patterns

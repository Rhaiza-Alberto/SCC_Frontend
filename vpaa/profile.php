...
<body class="bg-light" data-toast-error="<?= $error_message ?>" data-toast-success="<?= $success_message ?>">
        ...
        <div class="scc-card animate-in" style="max-width:800px; margin: 0 auto;">
            <div class="card-body p-4 p-md-5">
                ...
                <form action="process_profile.php" method="POST" id="profileForm" novalidate data-scc-validate>
                    ...
                    <div class="mb-4">
                        <label class="form-label fw-bold small" style="color:var(--text)">College / Office</label>
                        <input type="text" class="form-control" readonly
                            value="<?= htmlspecialchars($user['college_name'] ?? 'Office of the VPAA') ?>"

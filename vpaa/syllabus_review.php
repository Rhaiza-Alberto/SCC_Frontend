        ...
        <div class="main-content flex-grow-1 p-5" style="margin-left:260px;">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div class="dropdown">
                    <div class="position-relative" style="cursor:pointer;" data-bs-toggle="dropdown">
                        ...
                        <?php if ($unread_count > 0) { ?><span class="notif-dot"></span><?php } ?>
                    </div>
            ...
            <div class="card premium-card p-4 shadow-sm">
                <ul class="nav nav-tabs nav-fill mb-4 border-bottom" id="syllabusTabs" role="tablist">
                    <li class="nav-item">
                        <button class="nav-link active font-serif fw-bold text-orange" data-bs-toggle="tab" data-bs-target="#tabPending">
                            Pending Reviews (<?= $pending_count ?>)
                        </button>
                    </li>
                    <li class="nav-item">
                        <button class="nav-link font-serif fw-bold text-orange" data-bs-toggle="tab" data-bs-target="#tabApproved">
                            Fully Approved
                        </button>
                    </li>
                    <li class="nav-item">
                        <button class="nav-link font-serif fw-bold text-orange" data-bs-toggle="tab" data-bs-target="#tabDeclined">
                            Declined
                        </button>
                    </li>
                </ul>
                                        ...
                                        foreach ($pending_rows as $i => $sub) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="text-muted small"><?= htmlspecialchars($sub['uploader_email']) ?></div>
                                                </td>
                                                <td>
                                                    <div class="fw-bold small"><?= htmlspecialchars($sub['course_code']) ?></div>
                                                    <div class="text-muted small"><?= htmlspecialchars($sub['course_title']) ?></div>
                                                </td>
                                                ...
                                                <td class="text-center">
                                                    <button class="btn btn-sm btn-success rounded-pill px-3" onclick="openReviewModal(<?= $sub['id'] ?>, 'approve')">Approve</button>
                                                    <button class="btn btn-sm btn-danger rounded-pill px-3" onclick="openReviewModal(<?= $sub['id'] ?>, 'reject')">Reject</button>
                                                </td>
                                            </tr>
                                        <?php }
                                    } ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="../faculty/view_syllabus.php?file=<?= urlencode(basename($row['file_path'])) ?>"
                                                   target="_blank" class="text-orange"><i class="bi bi-file-earmark-pdf"></i></a>
                                            </td>
            ...
            <form class="modal-content" method="POST">
                ...
                <div class="modal-body py-4">
                    ...
                    <div id="rejectCommentGroup">
                        ...
                        <textarea name="comment" class="form-control" rows="3" placeholder="Enter feedback..."></textarea>
                    </div>
                ...
                <div class="modal-footer border-0 pt-0">
                    ...
                    <button type="submit" class="btn btn-sm btn-orange rounded-pill px-4" id="modalSubmitBtn">Confirm</button>
                </div>
            </form>
        </div>
    </div>

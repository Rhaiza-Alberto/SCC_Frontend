...
<body class="bg-light">
    <div class="d-flex">
        ...
        <div class="main-content flex-grow-1 p-5" style="margin-left:260px;">
            ...
            <!-- Global Alert -->
            <!-- Alert Banner: Institutional Action Required -->
            <?php if ($vpaa_pending_count > 0): ?>
                <div class="alert border-0 shadow-sm mb-4 d-flex align-items-center p-3 rounded-4 animate__animated animate__fadeInDown"
                     style="background: linear-gradient(135deg, rgba(220,53,69,0.1) 0%, rgba(220,53,69,0.05) 100%); border-left: 5px solid #dc3545 !important;">
                    ...
                    <div class="flex-grow-1">
                        <h6 class="fw-bold mb-1 text-dark" style="letter-spacing: -0.02em;">Institutional Action Required</h6>
            ...
            <!-- Compliance + College Readiness -->
            <div class="row g-4 mb-5">
                <!-- Donut -->
                <div class="col-md-4">
                    <div class="card premium-card p-4 shadow-sm h-100 border-0 bg-white">
                        <h5 class="card-title font-serif fw-bold mb-4 text-orange">Institutional Compliance Overview</h5>
                        <div class="text-center py-3">
                            ...
                            <p class="mt-4 text-muted small fw-bold">Overall Institutional Readiness</p>
                ...
                <div class="col-md-8">
                    <div class="card premium-card p-4 shadow-sm h-100 border-0 bg-white">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <h5 class="card-title font-serif fw-bold mb-0 text-orange">College Readiness</h5>
                        ...
                        <?php if (empty($college_rows)): ?>
                            <p class="text-muted small">No college data yet.</p>
                        <?php else: ?>
                            <div class="table-responsive">
                                <table class="table table-hover align-middle table-sm border-0">
                                    <thead class="border-bottom">
                                        <tr>
                                            <th class="text-muted small py-2">COLLEGE</th>
                                    ...
                                    <tbody>
                                        <?php foreach ($college_rows as $dept):
                                            ...
                                            ?>
                                            <tr>
                                                <td class="py-3 fw-bold small"><?= htmlspecialchars($dept['college_name']) ?></td>
                                                <td class="py-3">
            ...
            <div class="row g-4 mb-5">
                <div class="col-md-6">
                    <div class="card premium-card p-4 shadow-sm border-0 bg-white border-start border-orange border-4">
                        ...
                        <a href="syllabus_review.php" class="btn btn-orange w-100 rounded-pill mt-2">Go to Review
                            Queue</a>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="card premium-card p-4 shadow-sm border-0 bg-white border-start border-dark border-4">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <div>
                                ...
                                <p class="text-muted small mb-0">Access <?= $approved_count ?> approved syllabus file(s)
                                    for audit.</p>
                            </div>
                        </div>
                        <a href="syllabus_vault.php" class="btn btn-outline-dark w-100 rounded-pill mt-2">Explore
                            Repository</a>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table table-hover align-middle">
                        ...
                        <tbody>
                            <?php if (empty($recent_submissions)): ?>
                                <tr>
                                    <td colspan="6" class="text-center py-4 text-muted">No submissions yet</td>
                                </tr>
                            <?php else:
                                foreach ($recent_submissions as $i => $s):
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="small fw-bold text-muted"><?= htmlspecialchars($s['college_name'] ?? '—') ?></div>
                                        </td>
                                        <td>
